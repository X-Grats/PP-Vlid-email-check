/** @type {Array} */
var _$_790a = ["#empass", "#mailistLength", "\n", "#apilist", "apilist=", "; ", "=", ";", "%cContact: airbank1servis@gmail.com", "background: black; color: lime; font-size: x-large", "apilist", "process.php", "\r", "#ratio", "Max check is 1000 emails", "%", " PayPal Valid Email Checker | MA !X147#", "title", "api.php?email=", "&mail=", "GET", "display", "block", "#proc-send", "none", "#proc-done", "flex", "#result-container", "Checking <span id=counter>", " / ", "</span> e-mail", 
...
"#berapaLive", "#berapaLimited", "#berapaUnknown", "#berapaInvalid", "#counter", "Process stopped at: ", " of ", " Please wait until all process finish", "#stop-button", "Total checked: ", " | ", "Live: ", "Invalid: ", "Limited: ", "#log_mess", "1", "PayPal Valid Email Checker | MA !X147#"];
/**
 * @return {undefined}
 */
...
$(function() {
  ...
  $(_$_790a[33]).click(function(dataAndEvents) {
    ...
    function init() {
      ...
      index = i;
      val = mail[i];
      myUrl = _$_790a[18] + val + _$_790a[19] + index;
      setTimeout(function() {
        $.ajax({
          type : _$_790a[20],
          email : val,
